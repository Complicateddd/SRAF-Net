...
class NWDataset(torch.utils.data.Dataset):
    # CLASSES_NAME = (
    #     "__background__ ",
    #     "aeroplane",
    #     "bicycle",
    ...
    CLASSES_NAME = (
        "__background__ ",
    'airplane','ship','storagetank','baseballdiamond','tenniscourt',
    ...
    def __init__(self,root_dir,resize_size=[800,1024],split='trainval',use_difficult=False):
        ...
        self.name2id=dict(zip(NWDataset.CLASSES_NAME,range(len(NWDataset.CLASSES_NAME))))
...
if __name__ == '__main__':
    ...
    train_loader=torch.utils.data.DataLoader(train_dataset,batch_size=3,shuffle=False,collate_fn=train_dataset.collate_fn)
